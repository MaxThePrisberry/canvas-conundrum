...
import '../styles/setup-phase.css'; // ✅ FIXED: CSS import path
                  ...
                  {availableRoles.map((role, index) => {
                    ...
                    return (
                      <motion.button
                        ...
                        style={{
                          '--role-color': info?.color || Colors.primary
                        }}
                      >
                        <div className="role-icon">{info?.icon || '❓'}</div>
                        <h3>{info?.title || 'Unknown Role'}</h3>
                        <p>{info?.description || 'Unknown bonus'}</p>
                        {!role.available && (
          ...
          >
            ...
            >
              <div className="info-item">
                ...
                <span className="value">{roleInfo[selectedRole]?.title || 'Unknown'}</span>
              </div>
              <div className="info-item">
